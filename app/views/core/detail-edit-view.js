...
module.exports = Backbone.View.extend({
		...
		//load method.
		getModel: function getModelEdit(id) {
		...
		//save method. must return a promise.
		saveModel: function saveModelEdit(model) {
			throw new NotImplementedException('saveModel');
		},
		...
		save: function saveEdit(event) {
			...
			.then(function() {
				currentModel.unsetErrors();
				currentView.save(currentView.model)
