...
module.exports = Backbone.View.extend({
	...
	//load method.
	getModel: function getModelConsult(id){
	...
	//delete method. must return a promise.
	deleteModel: function deleteModelConsult(){
		throw new NotImplementedException('deleteModel');
	},
